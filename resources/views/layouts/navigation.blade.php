<nav x-data="{ open: false }" class="bg-gray-800 sticky top-0 z-10 border-b border-gray-100" class="bg-gray-800 sticky top-0 z-10">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link :href="route('home')" :active="request()->routeIs('home')" class="uppercase">
                {{ __('Book Training') }}
