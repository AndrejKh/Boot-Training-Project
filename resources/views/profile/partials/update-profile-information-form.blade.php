<section>
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6" enctype="multipart/form-data">
        ...
        <div>
            ...
            <x-text-input id="title" name="title" type="text" class="mt-1 block w-2/5 mr-1" :value="old('title', $user->title)" required autofocus autocomplete="title" />
        ...
        <div class="mt-4">
            ...
            <x-text-input id="jobTitle" class="block mt-1 w-full" type="text" name="jobTitle" :value="old('jobTitle', $user['trainer']->jobTitle)" required autocomplete="jobTitle" placeholder="Job Title"/>
            <x-input-error :messages="$errors->get('jobTitle')" class="mt-2" />
        </div>
        <div class="mt-4">
            <x-input-label for="provider" :value="__('Provider Name')" />
            <x-text-input id="provider" class="block mt-1 w-full" type="text" name="provider" :value="old('provider', $user['trainer']->provider)" required autocomplete="provider" placeholder="Provider Name"/>
